          ...
          children: [
            ...
            Stack(
              children: [
                CircleAvatar(
                  radius: 24,
                  backgroundColor: esAdmin ? ColoresApp.primario : ColoresApp.fondoClaro,
                  ...
                  child: usuario.fotoUrl.isEmpty
                      ? Text(
                          ...
                          style: TextStyle(
                            color: esAdmin ? Colors.white : ColoresApp.textoSecundarioClaro,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: esAdmin ? ColoresApp.primario.withValues(alpha: 0.1) : Colors.grey.shade100,
                      borderRadius: BorderRadius.circular(4),
                      border: Border.all(
                        color: esAdmin ? ColoresApp.primario.withValues(alpha: 0.3) : Colors.grey.shade300,
                        width: 0.5,
                      ),
                    ),
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 10,
                        fontWeight: FontWeight.bold,
                        color: esAdmin ? ColoresApp.primario : Colors.grey.shade600,
                      ),
                    ),
                  ),
                ],
